    ...
    <div class="container">
        <div class="row">
            ...
            <div class="card-coletor">
                ...
                <hr>
                <h5 class="title text-center">Produtos para Coleta</h5>
                <hr>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 text-center p-2">
                                    <button class="btn btn-sm btn-block btn-success btn-padding" type="submit">Iniciar Coleta</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 text-center p-2">
                                    <button class="btn btn-sm btn-block btn-danger btn-padding" type="submit">Interromper Coleta</button>
                                </div>
                            </div>
                        </div>
                    </form>
