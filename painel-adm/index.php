            ...
            <div id="content">
                ...
                <div class="container-fluid p-2 pt-1 m-0">
                    ...
                    if (@$pag == null) {
                        ...
                        @include_once(@$router_adm . @$dashboard . ".php");

                    } else if (@$pag == $menu1) {

                        @include_once(@$router_adm . @$menu1 . ".php");

                    } else if (@$pag == $menu2) {

                        @include_once(@$router_adm . @$menu2 . ".php");

                    } else if (@$pag == $menu3) {

                        @include_once(@$router_adm . @$menu3 . ".php");

                    } else if (@$pag == $menu4) {

                        @include_once(@$router_adm . @$menu4 . ".php");

                    } else if (@$pag == $menu5) {

                        @include_once(@$router_adm . @$menu5 . ".php");

                    } else if (@$pag == $menu6) {

                        @include_once(@$router_adm . @$menu6 . ".php");

                    } else if (@$pag == $menu9) {

                        @include_once(@$router_adm . @$menu9 . ".php");

                    } else if (@$pag == $menu10) {

                        @require_once(@$router_adm . @$menu10 . ".php");

                    } else if (@$pag == $menu11) {

                        @require_once(@$router_adm . @$menu11 . ".php");

                    } else if (@$pag == $menu12) {

                        @require_once(@$router_adm . @$menu12 . ".php");
